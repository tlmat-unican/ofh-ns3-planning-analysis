 ...
 */
#ifndef OFHV2_HELPER_H
#define OFHV2_HELPER_H
...
#include "ns3/ofh-applicationv2.h"
...
class Ofhv2Helper
{
  public:
    /**
     * Create an Ofhv2Helper to make it easier to work with OnOffApplications
     *
     ...
     *        to.
     */
    Ofhv2Helper(std::string protocol);
